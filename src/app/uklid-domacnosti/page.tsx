      ...
      <main className="main-content">
        ...
        <div className="container">
          ...
          <p>
            ...
            rychle. Stačí vyplnit <a href="#kontakt" className="btn-primary">kontaktní formulář</a> nebo nám zavolat.
          </p>

          <a href="/#kalkulacka" className="btn-primary">Spočítejte si cenu úklidu</a>
        </div>
      </main>
